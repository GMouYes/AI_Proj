...
def createSiteX(location:tuple):
	...
	build_on_cost = -1e6 # a huge number forcing not to build on
	newSite = Site(name="X", score=toxicScore, build_on_cost=build_on_cost, location=location)
...
def createSiteS(location:tuple):
	...
	build_on_cost = 1 
	newSite = Site(name="S", score=toxicScore, build_on_cost=build_on_cost, location=location)
...
def createZoneI(location):
	...
	newZone = Zone(name="I", score=score, location=location)
	return newZone
...
def createZoneC(location):
	...
	newZone = Zone(name="C", score=score, location=location)
	return newZone
...
def createZoneR(location):
	...
	newZone = Zone(name="R", score=score, location=location)
	return newZone
